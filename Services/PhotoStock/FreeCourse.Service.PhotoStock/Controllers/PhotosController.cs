...
namespace FreeCourse.Service.PhotoStock.Controllers
{
    ...
    {
        [HttpPost]
        public  async Task<IActionResult> PhotoSave(IFormFile photo,CancellationToken cancellationToken) // cancellationtoken => kişi dosyayı kaydederken browseri kapatırsa dosya yükleme işini otomatik olarak sonlandır. 
        {
